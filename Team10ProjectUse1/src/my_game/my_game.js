...
class MyGame extends engine.Scene {
    constructor() {
        ...
        this.mInventoryBackground = null;
    }
    ...
    init() {
        ...
        this.mPortal2 = new TextureObject(this.kMinionPortal, 40, 30, 10, 10);
        this.mPortal3 = new TextureObject(this.kMinionPortal, 30, 30, 10, 10);
        this.mPortal4 = new TextureObject(this.kMinionPortal, 20, 30, 10, 10);
        ...
        this.mInventory = new engine.Inventory(this.kBg);
        this.mInventory.setInventoryPosition(70, 70);
        this.mInventory.setInventorySize(40, 10);
    }
    ...
    draw() {
        ...
        this.mInventory.draw(this.mCamera);

        // Step  C: Draw everything
        this.mHero.draw(this.mCamera);
        this.mBrain.draw(this.mCamera);
        this.mPortal.draw(this.mCamera);
        this.mPortal2.draw(this.mCamera);
        this.mPortal3.draw(this.mCamera);
        this.mPortal4.draw(this.mCamera);
    ...
    update() {
        ...
        if (this.mPortal.pixelTouches(this.mCollide, h)) {
            ...
            this.mInventory.addItem(this.mPortal, 1);
        } else {
            this.mPortalHit.setVisibility(false);
        }

        // Portal intersects with which ever is selected
        if (this.mPortal2.pixelTouches(this.mCollide, h)) {
            this.mPortalHit.setVisibility(true);
            this.mPortalHit.getXform().setXPos(h[0]);
            this.mPortalHit.getXform().setYPos(h[1]);

            this.mInventory.addItem(this.mPortal2, 1);
        } else {
            this.mPortalHit.setVisibility(false);
        }

        // Portal intersects with which ever is selected
        if (this.mPortal3.pixelTouches(this.mCollide, h)) {
            this.mPortalHit.setVisibility(true);
            this.mPortalHit.getXform().setXPos(h[0]);
            this.mPortalHit.getXform().setYPos(h[1]);

            this.mInventory.addItem(this.mPortal3, 1);
        } else {
            this.mPortalHit.setVisibility(false);
        }

        // Portal intersects with which ever is selected
        if (this.mPortal4.pixelTouches(this.mCollide, h)) {
            this.mPortalHit.setVisibility(true);
            this.mPortalHit.getXform().setXPos(h[0]);
            this.mPortalHit.getXform().setYPos(h[1]);

            this.mInventory.addItem(this.mPortal4, 0);
        } else {
            this.mPortalHit.setVisibility(false);
        }
        ...
        if (engine.input.isKeyClicked(engine.input.keys.Z)) {
                let tempItemObject = this.mInventory.getItems()[0];
                this.mInventory.removeItem(tempItemObject);
                tempItemObject.setVisibility(false);

        }

        if (engine.input.isKeyClicked(engine.input.keys.C)) {
            let tempItemObject = this.mInventory.getItems()[0];
            if (this.mInventory.getObjectID(tempItemObject) == 0) {
                this.mInventory.removeItem(tempItemObject);
                tempItemObject.setVisibility(false);
            }
        }
